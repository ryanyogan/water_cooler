defmodule WaterCooler.ChatTest do
  use WaterCooler.DataCase

  alias WaterCooler.Chat

  describe "chat_conversations" do
    alias WaterCooler.Chat.Conversation
  ...
  describe "chat_conversation_members" do
    alias WaterCooler.Chat.ConversationMember
  ...
  describe "chat_messages" do
    alias WaterCooler.Chat.Message
  ...
  describe "chat_message_reactions" do
    alias WaterCooler.Chat.MessageReaction
  ...
  describe "chat_seen_messages" do
    alias WaterCooler.Chat.SeenMessage
